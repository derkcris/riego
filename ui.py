...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.2 on Mon Dec  5 03:10:11 2016
#
...
class Ventana(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.textPPM = wx.TextCtrl(self.panelPPM, wx.ID_ANY, "", style=wx.TE_CENTRE)
        ...
        self.comboIngredienteActivo = wx.ComboBox(self.panelIngredienteActivo, wx.ID_ANY, choices=[_("CaO - Nitrato de Calcio (26)"), _("N - Nitrato de Calcio (15.5)"), _("P205 - Fosfato Monopotasico (52)"), _("K20 - Fosfato Monopotasico (34)"), _("MgO - Nitrato de Magnesio (16)"), _("N - Nitrato de Magnesio (11)"), _("N - Acido Nitrico (15.5)"), _("K2O - Sultato de Potasio (50)")], style=wx.CB_DROPDOWN)
        ...
        self.textFertilizante1 = wx.TextCtrl(self.panelFertilizante1, wx.ID_ANY, "", style=wx.TE_CENTRE)
        ...
        self.comboIngredienteActivo1 = wx.ComboBox(self.panelIngredienteActivo1, wx.ID_ANY, choices=[_("CaO - Nitrato de Calcio (26)"), _("N - Nitrato de Calcio (15.5)"), _("P205 - Fosfato Monopotasico (52)"), _("K20 - Fosfato Monopotasico (34)"), _("MgO - Nitrato de Magnesio (16)"), _("N - Nitrato de Magnesio (11)"), _("N - Acido Nitrico (15.5)"), _("K2O - Sultato de Potasio (50)")], style=wx.CB_DROPDOWN)
        ...
        self.Bind(wx.EVT_TEXT, self.calcularPPM, self.textPPM)
        self.Bind(wx.EVT_TEXT, self.calcularFertilizante, self.textFertilizante)
        self.Bind(wx.EVT_COMBOBOX, self.cambiarIngrediente, self.comboIngredienteActivo)
        self.Bind(wx.EVT_TEXT, self.calcularFertilizante1, self.textFertilizante1)
        self.Bind(wx.EVT_TEXT, self.calcularPPM1, self.textPPM1)
        self.Bind(wx.EVT_COMBOBOX, self.cambiarIngrediente1, self.comboIngredienteActivo1)
    ...
    def calcularDatos(self, event):  # wxGlade: Ventana.<event_handler>
        print "Event handler 'calcularDatos' not implemented!"
        event.Skip()

    def calcularPPM(self, event):  # wxGlade: Ventana.<event_handler>
        print "Event handler 'calcularPPM' not implemented!"
        event.Skip()

    def calcularFertilizante(self, event):  # wxGlade: Ventana.<event_handler>
        print "Event handler 'calcularFertilizante' not implemented!"
        event.Skip()

    def cambiarIngrediente(self, event):  # wxGlade: Ventana.<event_handler>
        print "Event handler 'cambiarIngrediente' not implemented!"
        event.Skip()

    def calcularFertilizante1(self, event):  # wxGlade: Ventana.<event_handler>
        print "Event handler 'calcularFertilizante1' not implemented!"
        event.Skip()

    def calcularPPM1(self, event):  # wxGlade: Ventana.<event_handler>
        print "Event handler 'calcularPPM1' not implemented!"
        event.Skip()

    def cambiarIngrediente1(self, event):  # wxGlade: Ventana.<event_handler>
        print "Event handler 'cambiarIngrediente1' not implemented!"
        event.Skip()

    def limpiar(self, event):  # wxGlade: Ventana.<event_handler>
        print "Event handler 'limpiar' not implemented!"
        event.Skip()
